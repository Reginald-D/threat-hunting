...
6. Create a folder on your desktop called ```tor.txt``` and put a few fake (illicit) items in there
7. Delete the file.
...
## Created By:
- **Author Name**: Reginald D
- **Author Contact**: https://www.linkedin.com/in/reginald-d/
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `February  14, 2026`  | `Reginald D`   
